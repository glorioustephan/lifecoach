...
export const buildRecallTool = (memory: Memory) =>
  tool(
    "recall",
    "Search the user's memory by meaning. Use this whenever you need context the user hasn't restated in this session — past mentions of a topic, related facts, prior conversations, ingested documents. Returns scored snippets.",
    {
      query: z.string().min(1).describe("Natural-language search query"),
      scope: z
        .enum(["facts", "documents", "messages", "reflections", "all"])
        .optional()
